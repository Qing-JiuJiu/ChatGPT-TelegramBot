...
public enum ConfigEnum {
    ...
    START_MSG("start_msg","已新建 ChatGPT 对话，你可以发送 /response 重新回到上一次对话（该消息由 TelegramBot 发出）"),
    ...
    CHATGPT_ERROR_MSG("chatgpt_error_msg","ChatGPT 响应失败，请发送 /response 重试，若频繁出现此问题，请联系管理员（该消息由 TelegramBot 发出）"),
